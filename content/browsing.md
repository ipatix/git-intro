...
1. Go to the repository view on GitHub:
   - <https://github.com/ipatix/recipe-book>: you can use this one if you don't want your fork and contributions
     to be visible on the stream or the recording
   - <https://github.com/ipatix/recipe-book-recorded>: we will use this one for the demonstration which is streamed and recorded
...
* CodeRefinery upstream repository: https://github.com/**ipatix**/recipe-book
...
repository **ipatix/recipe-book**, (not your fork):
<https://github.com/ipatix/recipe-book>.  {term}`Issues <issue>`
